...
//menambah barang baru
	...
	if(isset($_POST['barangmasuk'])){
		...
		$addtomasuk = mysqli_query($conn,"insert into masuk (idbarang, keterangan, qty) values('$barangnya',
			'$penerima','$qty')");
...
//menambah barang keluar
	if(isset($_POST['addbarangkeluar'])){
		...
		$addtokeluar = mysqli_query($conn,"insert into keluar (idbarang, penerima, qty) values('$barangnya',
			'$penerima','$qty')");
		$updatestockmasuk = mysqli_query($conn, "update stock set stock='$tambahkanstocksekarangdenganquantity' where idbarang='$barangnya'");
	...
	if (isset($_POST['hapusbarang'])) {
		...
		$hapus =  mysqli_query($conn, "delete from stock set idbarang='$idb'");
		if($hapus){
			header('location:index.php');
		}else{
			echo 'Gagal';
	...
	if (isset($_POST['updatebarangmasuk'])) {
		...
		$qtysekarang = mysqli_query($conn, "select * from masuk where idm='$idm'");
